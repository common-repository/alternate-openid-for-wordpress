...
error_log('fn GetOpenIDServer openid_url_identity has been set to: '.$this->openid_url_identity);
wp_die( __('uggg stopping.') );

    $response = $this->CURL_Request($this->openid_url_identity);
error_log('fn GetOpenIDServer CURL_Request Response has been set to: '.$response);
wp_die( __('uggg stopping.') );
