...
/*
  ...
  slightly modified by Jerry Yeager http://www.scene-naturally.dyndns.org
...
For example:
  ...
  This may not be compatible with current specs, but it works in current enviroment. Use this function to get openid
...
class SimpleOpenID{
  ...
  function OpenID_Standarize($openid_identity){
    ...
    if(substr($u['host'],0,4) == 'www.'){
     $u['host'] = substr($u['host'], 4, strlen($u['host']));
    }
